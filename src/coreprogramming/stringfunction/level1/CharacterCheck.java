...
/*
 * This program compares two strings using two methods:
 * 1. Character-by-character comparison using charAt()
 * 2. Built-in equals() method
 */
public class CharacterCheck {

    /*
     * This method checks if two strings are equal
     * by comparing characters one by one using charAt()
     */
    ...
    /*
     * This method checks if two strings are equal
     * using the built-in equals() method
     */
    ...
    public static void main(String[] args) {
        ...
        // Comparing strings using charAt() and equals()
